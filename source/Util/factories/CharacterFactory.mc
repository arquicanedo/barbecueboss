...
class CharacterFactory extends WatchUi.PickerFactory {
    ...
    function getDrawable(index, selected) {
        ...
        return new WatchUi.Text( { :text=>app.controller.storageGetValue(index), :color=>Graphics.COLOR_WHITE, :font=> Graphics.FONT_LARGE, :locX =>WatchUi.LAYOUT_HALIGN_CENTER, :locY=>WatchUi.LAYOUT_VALIGN_CENTER } );
    }
